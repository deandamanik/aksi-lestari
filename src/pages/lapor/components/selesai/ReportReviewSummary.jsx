...
import { AlertTriangleIcon, MapPinIcon, FileTextIcon, FlagIcon, RecycleIcon } from '../../../../components/common/Icons'
import ReportMapPreview from '../shared/ReportMapPreview'

function ReportReviewSummary({ temukan, kenali, aksi, onEditLocation, onEditDescription }) {
      ...
      <div className="pt-4.5 border-t border-stone-100 flex flex-col gap-3">
        <div className="flex items-center justify-between gap-2">
          ...
          <button
            ...
            aria-label="Ubah lokasi di langkah 1"
          >
            Ubah Lokasi
          </button>
        </div>
