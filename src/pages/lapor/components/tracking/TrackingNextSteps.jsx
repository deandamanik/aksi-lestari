  ...
  return (
    <div className="rounded-2xl bg-white border border-[#E8E5DC] shadow-xs p-5 sm:p-6 flex flex-col gap-3">
      ...
      <p className="text-xs sm:text-sm text-stone-600 leading-relaxed">
        Laporan akan diperiksa sebelum diteruskan ke proses penanganan. Kamu akan mendapatkan pembaruan setelah hasil validasi tersedia.
      </p>
      ...
      <div className="pt-2.5 border-t border-stone-100 flex items-center gap-2 text-xs text-stone-500">
        ...
        <span>XP dan Saldo Apresiasi akan diberikan setelah laporan mencapai status Selesai.</span>
      </div>
    </div>
  )
}
