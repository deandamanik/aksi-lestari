...
function PengaturanHapusModal({ isOpen, onClose, onConfirmDelete }) {
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-2xl border border-[#E8E5DC] p-6 sm:p-7 max-w-md w-full shadow-lg flex flex-col gap-5"
      ...
      >
        ...
        {/* Impact List */}
        <div className="bg-[#FAF9F4] rounded-xl border border-[#E8E5DC] p-4 text-xs text-stone-600 flex flex-col gap-2">
        ...
        <div className="flex items-center justify-end gap-3 pt-2">
          <button
            ...
            type="button"
            onClick={onClose}
            className="px-4 py-2 rounded-xl border border-[#E8E5DC] hover:border-stone-300 hover:bg-[#FAF9F4] text-stone-700 text-xs sm:text-sm font-semibold transition-colors focus:outline-hidden focus-visible:ring-2 focus-visible:ring-primary cursor-pointer"
          >
            Batal
          </button>
          <button
