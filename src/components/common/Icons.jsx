/**
 * Refined stroke-based Lucide-compatible icon components for AksiLestari.
 * Built with standard Lucide 24x24 viewBox, stroke-width 2, round linecap/join.
 */
...
export function SproutIcon({
  ...
  return (
    ...
    >
      ...
      <path d="M14.1 6a7 7 0 0 0-1.1 4c1.9-.1 3.3-.6 4.3-1.4 1-1 1.6-2.3 1.7-4.6-2.7.1-4.2 1.1-4.9 2z" />
    </svg>
  )
}
